...
from li_scanner.li_scanner.cardCreate import CardCreate
from li_scanner.li_scanner.addQuestions import ObjectiveQuestions
...
class CardDesign(QWidget):
    ...
    def createQuestionCard(self):
        ...
        CardCreate(idDigits, selNumberList,fillNumberList,subNumberList)
